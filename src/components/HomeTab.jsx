...
import {
  Search, X, ChevronRight, Flame, Zap, Award, Bell, Link2, Clock, RotateCcw
} from "lucide-react";
...
const HomeTab = ({ onRecipeClick, favorites, onFavorite, cooked, onNavigate, macroGoals, onResetDay, allRecipes }) => {

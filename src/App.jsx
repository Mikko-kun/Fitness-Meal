  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif", maxWidth: 430, margin: "0 auto", position: "relative" }}>
      ...
      <div className="flex-1 flex flex-col">
        {activeTab === "home" && <HomeTab onRecipeClick={setSelectedRecipe} favorites={favorites} onFavorite={toggleFavorite} cooked={cooked} onNavigate={setActiveTab} macroGoals={macroGoals} onResetDay={resetDay} allRecipes={ALL_RECIPES} />}
